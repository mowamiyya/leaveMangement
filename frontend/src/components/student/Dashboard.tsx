...
const Dashboard = () => {
  ...
  const cards = [
    ...
    { label: 'Pending Leaves', value: stats?.pendingLeaves || 0, icon: Clock, color: 'bg-yellow-500' },
    { label: 'Approved Leaves', value: stats?.approvedLeaves || 0, icon: CheckCircle, color: 'bg-green-500' },
    { label: 'Rejected Leaves', value: stats?.rejectedLeaves || 0, icon: XCircle, color: 'bg-red-500' },
  ]
