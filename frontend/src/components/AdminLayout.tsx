...
import { LayoutDashboard, Building2, GraduationCap, Users, UserCheck, Network, User, Settings, LogOut } from 'lucide-react'
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/admin/class-teachers', icon: Network, label: 'Class Teachers' },
