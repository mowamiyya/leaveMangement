...
import { LayoutDashboard, CheckSquare, History, User, Settings, LogOut, Network } from 'lucide-react'
...
const TeacherLayout: React.FC<TeacherLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/teacher/approvals', icon: CheckSquare, label: 'Approvals' },
    { path: '/teacher/history', icon: History, label: 'History' },
    { path: '/teacher/hierarchy', icon: Network, label: 'Hierarchy' },
